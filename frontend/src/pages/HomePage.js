...
export default function HomePage(){
 ...
 return <div className="estate-home">
  ...
  <section className="estate-section estate-about" id="about">
   <div className="estate-about-panel">
    <figure className="estate-about-photo"><img src="https://res.cloudinary.com/ddr5ek7jn/image/upload/v1773984631/%D0%9A%D0%BE%D0%BC%D0%B0%D0%BD%D0%B4%D0%B0_pdoing.png" alt="Команда DARS CAPITAL" loading="lazy" decoding="async"/><figcaption><span>DARS CAPITAL</span><span>Личный подход к недвижимости</span></figcaption></figure>
    <div className="estate-about-copy"><p className="estate-eyebrow">О НАС · КОМАНДА DARS CAPITAL</p><h2>Ваши интересы.<br/>Наша ответственность.</h2><p className="estate-about-intro">Мы представляем ваши интересы так, как представили бы свои. Работаем конфиденциально, точечно и на результат.</p>
     <div className="estate-about-values">{[[Compass,'Понимаем ваш запрос','Учитываем образ жизни, задачи и приоритеты при выборе недвижимости.'],[ShieldCheck,'Внимательны к деталям','Помогаем разобраться в характеристиках объекта и условиях сделки.'],[KeyRound,'Остаёмся рядом','От первого знакомства и просмотра до передачи ключей — с персональным консультантом.']].map(([Icon,title,text])=><div className="estate-about-value" key={title}><Icon size={21} aria-hidden="true"/><div><h3>{title}</h3><p>{text}</p></div></div>)}</div>
     <div className="estate-about-footer"><p>Премиальный сервис — наш стандарт в каждой коммуникации и каждой сделке.</p><Link to="/about" className="estate-button">Познакомиться с командой <ArrowUpRight size={18}/></Link></div>
    </div>
   </div>
  </section>
