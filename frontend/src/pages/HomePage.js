...
export default function HomePage(){
 ...
 return <div className="estate-home">
  ...
  <section className="estate-section estate-about" id="about"><img src="https://res.cloudinary.com/ddr5ek7jn/image/upload/v1773984631/%D0%9A%D0%BE%D0%BC%D0%B0%D0%BD%D0%B4%D0%B0_pdoing.png" alt="Команда DARS CAPITAL" loading="lazy" decoding="async"/><div><p className="estate-eyebrow">О НАС · КОМАНДА DARS CAPITAL</p><h2>Мы представляем ваши интересы так, как представили бы свои.</h2><p>Работаем конфиденциально, точечно и на результат. Для нас премиальный сервис — это не обещание, а стандарт в каждой коммуникации и каждой сделке.</p><Link to="/about" className="estate-button">Познакомиться с командой <ArrowUpRight size={18}/></Link></div></section>
