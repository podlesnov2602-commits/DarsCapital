...
const config={apartment:['Апартаменты','Квартиры и пентхаусы для жизни в ритме города'],villa:['Виллы и резиденции','Дома и земельные участки в Алматы и предгорьях'],commerce:['Коммерческая недвижимость','Помещения и здания для бизнеса']};
